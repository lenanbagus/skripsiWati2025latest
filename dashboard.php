        ...
        <div class="col-md-6 mb-3">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Aplikasi ini dibuat untuk memprediksi jumlah dan pertumbuhan penduduk di Kabupaten Bandung menggunakan metode Regresi Linear Berganda, Sebagai syarat kelulusan Sidang Skripsi Strata I</p>
